export const tasks_list = [
    {
        "id": 1,
        "title": "Inspect power grid infrastructure",
        "description": "Praesent luctus auctor lobortis. Cras hendrerit augue tortor.",
        "status": "To do",
    ...
    },
    {
        ...
        "description": "Vestibulum quis facilisis neque. Nunc mattis pretium nisi sed volutpat.",
        "status": "To do",
    ...
    {
        "id": 3,
        "title": "Replace old power lines",
        "description": "Donec pellentesque hendrerit lectus, quis laoreet lectus convallis eu.",
        "status": "In progress",
    ...
    {
        "id": 4,
        "title": "Develop renewable energy strategy",
        "description": "Curabitur a justo ut erat consequat viverra.",
        "status": "Done",
    ...
    },
    {
        ...
        "description": "Pellentesque dolor ex, ornare nec eleifend et, cursus ac tortor.",
        "status": "To do",
    ...
    {
        "id": 7,
        "title": "Upgrade transformer station",
        "description": "Nulla facilisi. Phasellus at ante a dui pharetra cursus.",
        "status": "Done",
        "date_created": "2024-01-25",
    ...
    },
    {
        ...
        "description": "Quisque accumsan massa elit, et accumsan augue tempus maximus.",
        "status": "To do",
    ...
    },
    {
        "id": 9,
        "title": "Inspect power grid infrastructure",
        "description": "Maecenas ac ante sit amet nisi lacinia finibus ut et lorem.",
        "status": "Done",
